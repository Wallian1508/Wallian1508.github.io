...
void dfs(vector<string>& data, vector<bool>& already, int a, vector<string> now, long long& count)    //僅data會影響外面(&)
{
    int k = 0;
            ...
            for(int g = 1; g <= k && !isalpha(now[j][i]) ; g++) //方向
            {
                if(a == 0) //A
                {
                    ...
                    else                                //填進去了
                    {
                        ...
                        dfs(data, already, a + 1, A(now, j, i, g), count); //呼叫自己開始算下一個(a+1)
                ...
                else if(a == 1) //B
                {
                    ...
                    {
                        already[a] = 1;
                        dfs(data, already, a + 1, B(now, j, i, g), count);
                        already[a] = 0;
                    }
                }
                else if(a == 2) //C
                {
                    ...
                    {
                        already[a] = 1;
                        dfs(data, already, a + 1, C(now, j, i, g), count);
                        already[a] = 0;
                    }
                }
                else if(a == 3) //D
                {
                    ...
                    {
                        already[a] = 1;
                        dfs(data, already, a + 1, D(now, j, i, g), count);
                        already[a] = 0;
                    }
                }
                else if(a == 4) //E
                {
                    ...
                    {
                        already[a] = 1;
                        dfs(data, already, a + 1, E(now, j, i, g), count);
                        already[a] = 0;
                    }
                }
                else if(a == 5) //F
                {
                    ...
                    {
                        already[a] = 1;
                        dfs(data, already, a + 1, F(now, j, i, g), count);
                        already[a] = 0;
                    }
                }
                else if(a == 6) //G
                {
                    ...
                    {
                        already[a] = 1;
                        dfs(data, already, a + 1, G(now, j, i, g), count);
                        already[a] = 0;
                    }
                }
                else if(a == 7) //H
                {
                    ...
                    {
                        already[a] = 1;
                        dfs(data, already, a + 1, H(now, j, i, g), count);
                        already[a] = 0;
                    }
                }
                else if(a == 8) //I
                {
                    ...
                    {
                        already[a] = 1;
                        dfs(data, already, a + 1, I(now, j, i, g), count);
                        already[a] = 0;
                    }
                }
                else if(a == 9) //J
                {
                    ...
                    {
                        already[a] = 1;
                        dfs(data, already, a + 1, J(now, j, i, g), count);
                        already[a] = 0;
                    }
                }
                else if(a == 10) //K
                {
                    ...
                    {
                        already[a] = 1;
                        dfs(data, already, a + 1, K(now, j, i, g), count);
                        already[a] = 0;
                    }
                }
                else if(a == 11) //L
                {
                    ...
                    {
                        already[a] = 1;
                        dfs(data, already, a + 1, L(now, j, i, g), count);
                        already[a] = 0;
                    }
                }
            }
...
int main()
{
    ...
    dfs(data, already, 0, data, count);    //開始遞迴DFS求解
